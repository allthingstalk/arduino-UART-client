...
This sketch is an example sketch to deploy the Grove Temperature Humidity (101020019) to the
...
1. Setup the Arduino hardware
  ...
  - Connect a Grove Temperature Humidity to pin D7 of the Arduino shield
